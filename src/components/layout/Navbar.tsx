...
export function Navbar() {
  const { pdfFile, annotations, undo, redo, pastAnnotations, futureAnnotations, zoom, setZoom, openedFromDashboard, resetWorkspace } = useWorkspaceStore()
  ...
  return (
    <header className="absolute top-0 left-0 right-0 h-[72px] flex items-center justify-between px-6 z-50">
      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        <div className="flex flex-col">
          <span className="text-sm font-semibold text-slate-900 dark:text-white flex items-center gap-2">
            ...
            <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-400">PDF</span>
          </span>
      ...
      <div className="flex items-center justify-end gap-2 flex-1">
        ...
        <div className="hidden md:flex items-center gap-2 text-xs font-medium text-emerald-600 dark:text-emerald-500 bg-emerald-50 dark:bg-emerald-500/10 px-3 py-1.5 rounded-full border border-emerald-200 dark:border-emerald-500/20 mr-2 whitespace-nowrap">
